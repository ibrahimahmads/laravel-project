        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-2xl shadow-slate-200/60 sm:rounded-2xl border border-slate-100 p-8">
                ...
                <div class="mb-2 border-b border-slate-100">
                    ...
                    <p class="text-xs text-slate-400 mt-1">Silakan isi detail produk di bawah ini dengan benar untuk menambahkannya ke inventaris.</p>
                </div>
                ...
                <form action="{{ route('products.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" 
                               ...
                               required 
                               class="block w-full rounded-xl border-slate-200 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-100 transition py-3 px-4 text-sm text-slate-700 placeholder-slate-400">
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative mt-1 rounded-xl shadow-sm">
                            ...
                            <input type="number" 
                                   ...
                                   step="0.01"
                                   required 
                                   class="block w-full rounded-xl border-slate-200 pl-11 pr-4 focus:border-indigo-500 focus:ring focus:ring-indigo-100 transition py-3 text-sm text-slate-700 placeholder-slate-400">
                        </div>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <textarea name="description" 
                                  ...
                                  required 
                                  class="block w-full rounded-xl border-slate-200 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-100 transition py-3 px-4 text-sm text-slate-700 placeholder-slate-400"></textarea>
                    </div>
                    ...
                    <div class="flex items-center justify-end gap-3 pt-4 border-t border-slate-100">
                        ...
                        <button type="submit" 
                                class="px-6 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-sm rounded-xl shadow-lg shadow-indigo-100 transition">
                            Simpan Produk
                        </button>
                    </div>
                </form>
